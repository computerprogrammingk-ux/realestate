...
public class LoginOptionsActivity extends AppCompatActivity {
    ...
    private void beginningGoogleLogin() {
        Log.e(TAG, "beginGoogleLogin:");

        Intent googlesignIntent = mGoogleSignInClient.getSignInIntent();
        googleSignInnARL.launch(googlesignIntent);
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        try {
                            ...
                            Log.e(TAG, "onActivityResult : AccountID" + account.getId());
    ...
    private void setFirebaseAuthWithGoogleAccount(String idToken) {
        Log.d(TAG, "setFirebaseAuthWithGoogleAccount:idToken: " + idToken);
        ...
        progressDialog.show();
        long timesamp=MyUtils.timestamp();
        ...
        String name=firebaseAuth.getCurrentUser().getDisplayName();
            ...
            hashMap.put("email",registeredEmail);
            hashMap.put("name",name);
            hashMap.put("timesamp",timesamp);
